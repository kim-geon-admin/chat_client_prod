...
export default function IconTabs(props) {
  ...
  return (
    ...
    <Box sx={{ height: 1 }} >      
        ...
        {
          value == 0 && <FriendList userId={id} setTabNumber={setValue} setDetailValue={setDetailValue} setChatRomm ={setChatRomm} /> ||
          value == 1 && detailValue == 'chat' && <ChatRoom userId={id} chatRoom={chatRoom} /> ||
